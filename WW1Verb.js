...
//imperfect
  ...
  impSecondPlTrans(){
    return "Ya'll were " +  this.verbing;
  }
  ...
  //future tense
   ...
   futPerSecondPlTrans(){
     return "Ya'll will have " +  this.ppVerb;
   }
...
//Condisder not duplicating this by eliminating the prior declaration
  verbArray = [[myVerb.imperativePl,myVerb.imperativePlTrans],[myVerb.imperativeSing,myVerb.imperativeSingTrans],[myVerb.actInfPres,myVerb.actInfPresTrans],[myVerb.firstSingPres,myVerb.firstSingPresTrans],[myVerb.secondSingPres,myVerb.secondSingPresTrans],[myVerb.thirdSingPres,myVerb.thirdSingPresTrans],[myVerb.firstPlPres,myVerb.firstPlPresTrans],[myVerb.secondPlPres,myVerb.secondPlPresTrans],[myVerb.thirdPlPres,myVerb.thirdPlPresTrans]];
